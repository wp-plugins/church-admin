...
echo'<ul><label for="subject">Rota Job:</label><input type="text" name="rota_task" /></li></ul>';
...
echo'<ul><label for="subject">Rota Job:</label><input type="text" name="rota_task" value="'.esc_sql($rota_task).'" /></li></ul>';
...
{
       echo '<table class="widefat"><thead><tr><th>Edit</th><th>Delete</th><th>Rota Task</th></tr></thead>';
    ...
    echo'<tfoot><tr><th>Edit</th><th>Delete</th><th>Rota Task</th></tr></tfoot></table>';
}
}
