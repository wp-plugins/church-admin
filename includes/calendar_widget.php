...
{
    $out.="<li>".mysql2date('D j M Y',$row->start_date).'</li><li>'.$row->start_time."<strong>".$row->title."</strong><br> ".$row->description."</li>";
}
$out.="</ul>";
if($postit)$out.='</div>';
return $out;
