...
global $wpdb;
$out='<div class="wrap"><h2>Small Groups</h2><p><a href="'.wp_nonce_url("admin.php?page=church_admin/index.php&amp;action=church_admin_add_small_group",'add small group').'">Add a small group</a></p>
<table class="widefat"><thead><tr><th>Edit</th><th>Delete</th><th>Group Name</th><th>Leaders</th><th>When</th></tr></thead>';
...
$out.="<tfoot><tr><th>Edit</th><th>Delete</th><th>Group Name</th><th>Leaders</th><th>When</th></tr></tfoot></table></div>";
echo $out;	
}
...
else
{
    ...
    if($people->counted>'0')
    {
        echo'<div class="wrap"><h2>Add New Small Group</h2><form action="" method="post">';
...
function church_admin_edit_small_group($id)
{
    ...
    echo'<div class="wrap"><div id="message" class="updated fade"><p><strong>Small Group Edited</strong></p></div>';
    church_admin_small_groups();
    }
    else
    {
	echo'<div class="wrap"><h2>Edit Small Group</h2><form action="" method="post">';
...
global $wpdb;
$wpdb->show_errors();
$out='<ul><li><label for="leaders">Leader:</label>';
//get people's names
...
$out.='<li><label for="group_name">Group name:</label><input type="text" name="group_name" value="'.esc_html(stripslashes($ld_row->group_name)).'" /></li><li><label for="when">When &amp; Where:</label><input type="text" name="whenwhere" value="'.esc_html(stripslashes($ld_row->whenwhere)).'" />
</li></ul>';
return $out;
}
