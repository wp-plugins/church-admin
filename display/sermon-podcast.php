 ...
 */
	...
	$header='';
	if(!empty($ca_podcast_settings['itunes_link']))$header.='<a title="'.__('Download on Itunes','church-admin').'" href="'.$ca_podcast_settings['itunes_link'].'"><img class="alignleft size-full wp-image-1701" alt="badge_itunes-lrg" src="'.CHURCH_ADMIN_IMAGES_URL.'badge_itunes-lrg.png" width="110" height="40" /></a><br style="clear:left;"/>';
